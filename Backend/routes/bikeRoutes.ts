...
import { getBikesByIndexAndLimit, getBikeCount, createBike, deleteBike, getRecommendedBikes, getTypes, updateBike } from '../controllers/bikeController';
...
router.get('/recommendations', getRecommendedBikes);
